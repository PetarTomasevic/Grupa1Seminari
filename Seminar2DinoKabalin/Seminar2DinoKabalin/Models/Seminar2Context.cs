...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ACER-DINOK;Initial Catalog=Seminar2;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Adrese>(entity =>
        {
            ...
            entity.Property(e => e.Kat).HasMaxLength(100);
            entity.Property(e => e.KucniBroj).HasMaxLength(100);
            entity.Property(e => e.NazivUlice).HasMaxLength(250);
        ...
        modelBuilder.Entity<Drzave>(entity =>
        {
            ...
            entity.Property(e => e.Kratica).HasMaxLength(50);
